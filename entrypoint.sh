...
prepare_liferay_tomcat_config() {
  ...
  sed -i 's/POSTGRESQL_USERNAME/$POSTGRESQL_USERNAME/g' /tmp/server.xml_template
  sed -i 's/POSTGRESQL_PASSWORD/$POSTGRESQL_PASSWORD/g' /tmp/server.xml_template
  sed -i 's/POSTGRESQL_URL/$POSTGRESQL_URL/g' /tmp/server.xml_template
